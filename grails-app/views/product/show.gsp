	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.restaurant}">
				<li class="fieldcontain">
					<span id="restaurant-label" class="property-label"><g:message code="product.restaurant.label" default="Restaurant" /></span>
					
						<span class="property-value" aria-labelledby="restaurant-label"><g:link controller="restaurant" action="show" id="${productInstance?.restaurant?.id}">${productInstance?.restaurant?.encodeAsHTML()}</g:link></span>
